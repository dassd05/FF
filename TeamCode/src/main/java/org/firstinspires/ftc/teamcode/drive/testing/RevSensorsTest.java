...
//        distance2 = hardwareMap.get(Rev2mDistanceSensor.class, "distance2");
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("1 distance", color1.getDistance(DistanceUnit.INCH) + " in");
...
//            telemetry.addData("distance1", String.format("%2fcm", distance1.getDistance(DistanceUnit.CM)));
